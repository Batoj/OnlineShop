...
public class CartItemController {
    ...
    public void addCartItem(@PathVariable(value = "productId") int productId) {
   	 ...
   	 for (int i = 0; i < cartItems.size(); i++) {
   		 ...
   		 if (product.getId() == (cartItem.getProduct().getId())) {	//if item i want to get already in cart just add 1 in num
   	 ...
   	 CartItem cartItem = new CartItem();	//if not in cart, create new item in cart
